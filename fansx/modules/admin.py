...
async def _(client, message):
    ...
    if message.command[0] == "kick":
        ...
        msg_kick = f"""
<blockquote><b>{bcs}Warning: {mention}<b>
<b>Admin: {message.from_user.mention}</b>
<b>{ktrng}Alasan: {reason}</b></blockquote>

<blockquote><b>Userbot 5k/bulan by @UserbotIzal_bot</b></blockquote>
            """
        try:
...
<blockquote><b>{bcs}warning: {mention}</b>
<b>admin: {message.from_user.mention}</b>
<b>{ktrng}alasan: {reason}</blockquote></b>\n<blockquote><b>Ket: ᴍᴀᴍᴘᴜs ᴅɪ ᴍᴜᴛᴇ ᴇᴛᴍɪɴ</blockquote></b>
