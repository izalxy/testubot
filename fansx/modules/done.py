...
async def done_command(client, message):
    ...
    try:
        ...
        response = (
            ...
            f"<blockquote>ᴛᴇʀɪᴍᴀᴋᴀsɪʜ ᴛᴇʟᴀʜ ᴏʀᴅᴇʀ</blockquote> userbot by @ekikjembut"
        )
...
async def done_command(client, message):
    ...
    try:
        ...
        response = (
            ...
            f" <blockquote><b> ᴛᴇʀɪᴍᴀᴋᴀsɪʜ ᴛᴇʟᴀʜ ᴏʀᴅᴇʀ ᴅɪ <a href=tg://openmessage?user_id={OWNER_ID}>userbot by @ekikjembut ✮</a></blockquote"
            f" <blockquote>ᴛᴇsᴛɪᴍᴏɴɪ : <a href=https://t.me/ekikjembott>ᴄʟɪᴄᴋ</a> </blockquote>"
        )
        await izzy_ganteng.edit(response)
