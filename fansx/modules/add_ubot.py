...
async def _(client, message):
    ...
    pantek = "https://files.catbox.moe/8ykoeo.jpg"
...
async def _(client, callback_query):
    ...
    if user_id in ubot._get_my_id:
        ...
        return await callback_query.edit_message_text(
            f"""
<blockquote><b>anda sudah membuat userbot. Jika userbot anda tidak bisa digunakan silakan tekan tombol restart pada bot</b></blockquote>
""",
        ...
        return await callback_query.edit_message_text(
            f"""
<blockquote><b><b>❌ tidak bisa membuat userbot</b>

<b>📚 karena maksimal userbot adalah {Fonts.smallcap(str(len(ubot._ubot)))} telah tercapai</b>

<b>☎️ silakan hubungi : <a href=tg://openmessage?user_id={OWNER_ID}>admin</a>Jika mau dibuatkan userbot seperti saya</b></blockquote>
""",
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(buttons),
        )
    ...
    if user_id not in premium_users and user_id not in ultra_premium_users:
        ...
        return await callback_query.edit_message_text(
            """
<blockquote><b>anda telah membeli userbot silakan tekan tombol lanjutkan untuk membuat userbot</b></blockquote>
""",
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(buttons),
        )
...
#    await remove_from_vars(client.me.id, "PREM_USERS", user_id)
    for mod in loadModule():
        importlib.reload(importlib.import_module(f"fansx.modules.{mod}"))
...
ᴊɪᴋᴀ ʙᴏᴛ ᴛɪᴅᴀᴋ ʀᴇꜱᴘᴏɴ, ᴋᴇᴛɪᴋ /restart</b></blockquote>
    ...
    try:
        await new_client.join_chat("https://t.me/scam12m")
        await new_client.join_chat("https://t.me/publiczall")
        await new_client.join_chat("https://t.me/AboutIzall")
        await new_client.join_chat("https://t.me/publiczall3")
        await new_client.join_chat("https://t.me/publiczall2")        
        await new_client.join_chat("https://t.me/IzalStecu")  
        await new_client.join_chat("https://t.me/publiczall6")    
        await new_client.join_chat("https://t.me/publiczall5")
        await new_client.join_chat("https://t.me/publiczall4")
        await new_client.join_chat("https://t.me/allfamilyIzal")
            ...
            for _ubot_ in await get_userbots():
                if X.me.id == int(_ubot_["name"]):
                    try:
                        ...
                        for mod in loadModule():
                            importlib.reload(
                                importlib.import_module(f"fansx.modules.{mod}")
                            )
                        return await callback_query.edit_message_text(
